...
export const reviewBuildTool = {
	...
	description:
		...
		"review-prev.md guidance when present. `effort` controls reasoning depth: 'high' " +
	...
	inputSchema: {
		...
		properties: {
			...
			effort: {
				...
				enum: ["high", "xhigh", "max"],
				description:
					"Reviewer effort. Defaults to 'high'. Use 'xhigh' for cross-subsystem runs, 'max' for architectural changes -- costs scale steeply.",
			},
		},
		required: ["run_id"],
	},
